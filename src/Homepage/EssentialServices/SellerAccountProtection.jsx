...
const SellerAccountProtection = () => {
  const services = [
    ...
    "Performance notification alerts",
    "Preventive action recommendations",
    "Listing quality monitoring",
    "Buyer complaint analysis",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 to-blue-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-blue-900">Included Services</h2>
        ...
        >
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Talk to Our Experts</h2>
          <ul className="space-y-3 text-base sm:text-lg">
            ...
            >
              ...
              <a
                href="https://wa.me/923077971099?text=I%20need%20help%20with%20Amazon%20account%20protection"
                target="_blank"
