...
const Reimbursements = () => {
  const services = [
    "Inventory report audits for eligibility",
    "Filing claims for damaged or lost units",
    "Monthly case follow-ups with Amazon",
    "Transparent tracking of recovered funds",
    "Warehouse discrepancy investigations",
    "Overcharge identification and claims",
    "Reimbursement appeal submissions",
    "Long-term inventory reconciliation"
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 to-blue-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-blue-900">Our Services</h2>
        ...
        >
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Let's Recover Your Money</h2>
          <ul className="space-y-3 text-base sm:text-lg">
            ...
            >
              ...
              <a
                href="https://wa.me/923077971099?text=Help%20me%20recover%20Amazon%20FBA%20reimbursements"
                target="_blank"
